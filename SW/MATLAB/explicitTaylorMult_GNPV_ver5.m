function [t,y,ORD,DY_all]=explicitTaylorMult_GNPV_ver5( ... 
    ...
    eps, ...  accuracy
    ind, ... indexes of the Taylor series for multiplicaton
...
%             DY_5terms_smaller(:,k) = sum(DY(j5,ind.DY_ijklm{2,k-1}(t5_new_start_smaller:end)).*DY(k5,ind.DY_ijklm{3,k-1}(t5_new_start_smaller:end)).*DY(l5,ind.DY_ijklm{4,k-1}(t5_new_start_smaller:end)),2); 
              ...
              %             ind.DY_ijklm{2,k-1}(t5_new_start_smaller:end)
%             ind.DY_ijklm{3,k-1}(t5_new_start_smaller:end)
%             ind.DY_ijklm{4,k-1}(t5_new_start_smaller:end)
...
%          fprintf('i: %d DY1: %g, DY2: %g , DY3: %g , DY4: %g \n',i,DY(1,k+1),DY(2,k+1),DY(3,k+1),DY(4,k+1))
