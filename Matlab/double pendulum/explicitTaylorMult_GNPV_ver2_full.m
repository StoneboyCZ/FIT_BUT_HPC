function [t,y,ORD,DY_all]=explicitTaylorMult_GNPV_ver2_full(h,tspan,init,A,A2,A3,A4,A5,b,ij,ijk,ijkl,ijklm,eps,ind,maxORD)
...
%         A5_diff = (A5y - A5y_GN)'
    ...
    if k > maxORD % max ORD was reached
        ...
        fprintf('GN: Halving integration step size. %g\n',t(i-1))
    else
%         DY_all{i-1}=DY;
%         if k<(stopping+4)
%             h=h*2;
