function [t,y,ORD,DY_all]=explicitTaylorMult_GNPV_ver2(h,tspan,init,A,A2,A3,b,ij,ijk,eps,ind,maxORD)
...
%     end
    ...
    DY(:,2)=h*(Ay+A2y+A3y); % first derivative  
...
%         A5_diff = (A5y - A5y_GN)'
    ...
    if k > maxORD % max ORD was reached
        ...
        %fprintf('Halving integration step size (step %d, k %d).\n',i,k);
    else
%         DY_all{i-1}=DY;
%         if k<(stopping+4)
%             h=h*2;
